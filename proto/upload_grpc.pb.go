...
func (c *uploadServiceClient) Upload(ctx context.Context, opts ...grpc.CallOption) (UploadService_UploadClient, error) {
	stream, err := c.cc.NewStream(ctx, &UploadService_ServiceDesc.Streams[0], "/upload.UploadService/Upload", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *uploadServiceUploadClient) CloseAndRecv() (*UploadReply, error) {
...
func (x *uploadServiceUploadServer) SendAndClose(m *UploadReply) error {
